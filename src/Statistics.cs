...
namespace YOSHI
{
    ...
    {
        /// <summary>
        /// Easy access method to compute the mean of a list.
        /// </summary>
        /// <param name="list">List to compute the mean of. May not be empty.</param>
        ...
        {
            return list.Count > 0 ? list.Average() : throw new InvalidOperationException("List contains no elements");
        }
