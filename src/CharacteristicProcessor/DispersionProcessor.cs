...
namespace YOSHI.CharacteristicProcessorNS
{
    public static partial class CharacteristicProcessor
    {
        ...
        {
            List<BingAddress> addresses = community.Data.Addresses;
        ...
        /// <summary>
        /// Given a list of addresses, this method computes the list of geographical distances between each unique pair 
        /// of addresses. It computes the distance using the spherical distance.
        /// </summary>
        /// <param name="addresses">A list of addresses for which we want to compute the geographical
        /// distance between each pair.</param>
        /// <returns>A list of geographical distances between each unique pair of addresses.</returns>
        private static List<double> ComputeGeographicalDistances(List<BingAddress> addresses)
        {
        ...
        /// <summary>
        /// Given a list of addresses, this method checks for each address whether its country's Hofstede metrics are 
        /// known, and if so, compiles separate lists for the present corresponding hofstede indices (PDI, IDV, MAS, UAI)
        /// </summary>
        /// <param name="addresses">A list of addresses for which we want to retrieve the Hofstede indices.</param>
        ...
        private static (List<double> pdis, List<double> idvs, List<double> mass, List<double> uais)
            ComputeHofstedeIndices(List<BingAddress> addresses)
        {
            ...
            foreach (BingAddress address in addresses)
            {
        ...
        /// <summary>
        /// Nested class responsible for the Hofstede Indices. 
        /// </summary>
